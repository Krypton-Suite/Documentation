...
**C#**
``` C#
public abstract void DrawRibbonContextArrow(
...
**VB**
``` VB
Public MustOverride Sub DrawRibbonContextArrow ( 
...
#### Implements
<a href="acf90aa4-ffb6-ee13-dce8-a5652b68a1c7.md">IRenderGlyph.DrawRibbonContextArrow(PaletteRibbonShape, RenderContext, Rectangle, IPaletteRibbonGeneral, PaletteState)</a>  
