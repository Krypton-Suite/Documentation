# PaletteNavigatorOtherRedirect Class
...
**VB**
``` VB
Public Class PaletteNavigatorOtherRedirect
	Inherits Storage
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  TypeConverter  →  ExpandableObjectConverter  →  <a href="9ef2ca3a-e03e-8927-105a-2f9a6fbdf849.md">GlobalId</a>  →  <a href="8406cf55-79a3-e579-4094-be084e489431.md">Storage</a>  →  PaletteNavigatorOtherRedirect</td></tr>
</table>
...
<table>
<tr>
<td><a href="f8e87875-95f1-5ed2-e0c6-15653977f704.md">PaletteNavigatorOtherRedirect</a></td>
<td>Initialize a new instance of the PaletteNavigatorOtherRedirect class.</td></tr>
</table>
