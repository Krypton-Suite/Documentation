# SecondaryHeaderOutlookVisible Property
...
**C#**
``` C#
public InheritBool SecondaryHeaderOutlookVisible { get; set; }
```
**VB**
``` VB
Public Property SecondaryHeaderOutlookVisible As InheritBool
	Get
	Set
```
