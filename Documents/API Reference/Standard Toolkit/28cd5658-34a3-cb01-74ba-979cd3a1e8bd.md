...
**C#**
``` C#
public override void DrawRibbonOverflow(
...
**VB**
``` VB
Public Overrides Sub DrawRibbonOverflow ( 
...
#### Implements
<a href="f37e8081-c21f-e43f-0edb-6f505a8f02f5.md">IRenderGlyph.DrawRibbonOverflow(PaletteRibbonShape, RenderContext, Rectangle, IPaletteRibbonGeneral, PaletteState)</a>  
