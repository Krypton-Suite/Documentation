...
**C#**
``` C#
public sealed class ButtonEnabled : Enum
```
**VB**
``` VB
Public NotInheritable Class ButtonEnabled
	Inherits Enum
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  ValueType  →  Enum  →  ButtonEnabled</td></tr>
</table>
