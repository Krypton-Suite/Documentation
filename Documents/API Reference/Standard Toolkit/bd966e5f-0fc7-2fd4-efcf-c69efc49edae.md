...
**VB**
``` VB
Public MustOverride Sub DrawBorder ( 
...
#### Implements
<a href="26d904d8-0360-f643-fbf4-4308b3ef1ce2.md">IRenderBorder.DrawBorder(RenderContext, Rectangle, IPaletteBorder, VisualOrientation, PaletteState)</a>  
