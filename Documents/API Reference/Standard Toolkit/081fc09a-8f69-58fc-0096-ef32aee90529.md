# RibbonGroupNormalTrackingDark Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalTrackingDark = 28
```
**VB**
``` VB
Public Const RibbonGroupNormalTrackingDark As PaletteRibbonColorStyle = 28
```
