# SeparatorController.SeparatorIndicator Class


\[Missing &lt;summary&gt; documentation for "T:Krypton.Toolkit.SeparatorController.SeparatorIndicator"\]
...
**VB**
``` VB
Public Class SeparatorIndicator
	Inherits Form
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  Form  →  SeparatorController.SeparatorIndicator</td></tr>
</table>
...
<table>
<tr>
<td><a href="a1e5ea9c-e9d1-01a8-0083-9e8f6e5eea15.md">SeparatorController.SeparatorIndicator</a></td>
...
<tr>
<td><a href="00d747fc-bd66-0c72-9fda-b17baace0700.md">SolidRect</a></td>
...
<td>Clean up any resources being used.<br />(Overrides Form.Dispose(Boolean))</td></tr>
<tr>
...
<tr>
<td><a href="005ecb0a-a9af-f7ff-eabe-e447da5c53e6.md">ShowWithoutActivate</a></td>
...
<td>Causes all of the child controls within a control that support validation to validate their data.<br />(Inherited from Form)</td></tr>
<tr>
<td><a href="a853ca03-e7ea-4089-68cf-089faaf3e9fe.md">WndProc</a></td>
<td>Processes Windows messages.<br />(Overrides Form.WndProc(Message))</td></tr>
</table>
