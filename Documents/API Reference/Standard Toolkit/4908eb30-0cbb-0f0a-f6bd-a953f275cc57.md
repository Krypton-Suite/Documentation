# ContextMenuItemsCollection Field
...
**C#**
``` C#
public const PaletteMetricPadding ContextMenuItemsCollection = 29
```
**VB**
``` VB
Public Const ContextMenuItemsCollection As PaletteMetricPadding = 29
```
