# KryptonDataGridViewButtonCell Class
...
**VB**
``` VB
Public Class KryptonDataGridViewButtonCell
	Inherits DataGridViewButtonCell
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  DataGridViewElement  →  DataGridViewCell  →  DataGridViewButtonCell  →  KryptonDataGridViewButtonCell</td></tr>
</table>
...
<table>
<tr>
<td><a href="f8652d70-6464-523e-76be-913d2ab88c6c.md">KryptonDataGridViewButtonCell</a></td>
...
<tr>
<td><a href="f4307a24-c7c2-ae15-8fb9-fe6ba2aaa49d.md">ButtonStyle</a></td>
...
<tr>
<td>EditType</td>
<td>Gets the type of the cell's hosted editing control.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
...
<tr>
<td>FlatStyle</td>
<td>Gets or sets the style determining the button's appearance.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
...
<td>Gets the type of the formatted value associated with the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>Frozen</td>
...
<tr>
<td>UseColumnTextForButtonValue</td>
<td>Gets or sets a value indicating whether the owning column's text will appear on the button displayed by the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>Value</td>
<td>Gets or sets the value associated with this cell.<br />(Inherited from DataGridViewCell)</td></tr>
<tr>
<td>ValueType</td>
<td>Gets or sets the data type of the values in the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>Visible</td>
...
<tr>
<td><a href="4621ac64-162d-02a1-c566-99efd3a12649.md">Clone</a></td>
<td>This member overrides KryptonDataGridViewButtonCell.Clone.<br />(Overrides DataGridViewButtonCell.Clone())</td></tr>
<tr>
...
<td>Creates a new accessible object for the DataGridViewButtonCell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
...
<td>Returns the bounding rectangle that encloses the cell's content area.<br />(Overrides DataGridViewButtonCell.GetContentBounds(Graphics, DataGridViewCellStyle, Int32))</td></tr>
<tr>
...
<td>Returns the bounding rectangle that encloses the cell's error icon, if one is displayed.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>GetErrorText</td>
...
<tr>
<td><a href="c47d10a9-1c8e-a2a0-252c-875ddb0a5e50.md">GetPreferredSize</a></td>
<td>This member overrides DataGridViewCell.GetPreferredSize.<br />(Overrides DataGridViewButtonCell.GetPreferredSize(Graphics, DataGridViewCellStyle, Int32, Size))</td></tr>
<tr>
<td>GetSize</td>
<td>Gets the size of the cell.<br />(Inherited from DataGridViewCell)</td></tr>
<tr>
...
<tr>
<td>GetValue</td>
<td>Retrieves the text associated with the button.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
...
<td>Indicates whether a row is unshared if a key is pressed while the focus is on a cell in the row.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
...
<td>Indicates whether a row is unshared when a key is released while the focus is on a cell in the row.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
...
<td>Indicates whether a row will be unshared when the mouse button is held down while the pointer is on a cell in the row.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>MouseEnterUnsharesRow</td>
<td>Indicates whether a row will be unshared when the mouse pointer moves over a cell in the row.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>MouseLeaveUnsharesRow</td>
<td>Indicates whether a row will be unshared when the mouse pointer leaves the row.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
...
<td>Indicates whether a row will be unshared when the mouse button is released while the pointer is on a cell in the row.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>OnClick</td>
...
<tr>
<td>OnKeyDown</td>
<td>Called when a character key is pressed while the focus is on the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>OnKeyPress</td>
<td>Called when a key is pressed while the focus is on a cell.<br />(Inherited from DataGridViewCell)</td></tr>
<tr>
<td>OnKeyUp</td>
<td>Called when a character key is released while the focus is on the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>OnLeave</td>
<td>Called when the focus moves from the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>OnMouseClick</td>
...
<tr>
<td>OnMouseDown</td>
<td>Called when the mouse button is held down while the pointer is on the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>OnMouseEnter</td>
<td>Called when the mouse pointer moves over a cell.<br />(Inherited from DataGridViewCell)</td></tr>
<tr>
<td>OnMouseLeave</td>
<td>Called when the mouse pointer moves out of the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>OnMouseMove</td>
<td>Called when the mouse pointer moves while it is over the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td>OnMouseUp</td>
<td>Called when the mouse button is released while the pointer is on the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
<tr>
<td><a href="5a7efe68-4aab-b580-aa02-200f551f70d5.md">Paint</a></td>
<td>This member overrides DataGridViewCell.Paint.<br />(Overrides DataGridViewButtonCell.Paint(Graphics, Rectangle, Rectangle, Int32, DataGridViewElementStates, Object, Object, String, DataGridViewCellStyle, DataGridViewAdvancedBorderStyle, DataGridViewPaintParts))</td></tr>
<tr>
<td>PaintBorder</td>
...
<tr>
<td>ToString</td>
<td>Returns the string representation of the cell.<br />(Inherited from DataGridViewButtonCell)</td></tr>
</table>
