...
**C#**
``` C#
public const PaletteRibbonTextStyle RibbonAppMenuDocsEntry = 8
```
**VB**
``` VB
Public Const RibbonAppMenuDocsEntry As PaletteRibbonTextStyle = 8
```
