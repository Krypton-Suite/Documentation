# GlassCheckedTrackingStump Field
...
**C#**
``` C#
public const PaletteColorStyle GlassCheckedTrackingStump = 41
```
**VB**
``` VB
Public Const GlassCheckedTrackingStump As PaletteColorStyle = 41
```
