...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupAreaBorder = 18
```
**VB**
``` VB
Public Const RibbonGroupAreaBorder As PaletteRibbonColorStyle = 18
```
