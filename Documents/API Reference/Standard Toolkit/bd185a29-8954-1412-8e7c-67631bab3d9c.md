...
**VB**
``` VB
Public MustInherit Class VisualForm
	Inherits Form
	Implements IKryptonDebug
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  Form  →  VisualForm</td></tr>
<tr><td><strong>Derived</strong></td><td><a href="13b29650-b21b-35d6-8387-a6f0a5ca154d.md">Krypton.Toolkit.KryptonForm</a></td></tr>
<tr><td><strong>Implements</strong></td><td><a href="6899ed6c-2a78-c461-b574-fb8c8ccc28a6.md">IKryptonDebug</a></td></tr>
</table>
...
<table>
<tr>
<td><a href="a217f368-626d-d651-9844-85c2494200fa.md">VisualForm</a></td>
<td>Initialize a new instance of the VisualForm class.</td></tr>
</table>
...
<tr>
<td><a href="12ab313e-065e-ce2b-d03e-3aab612188a3.md">CreateRedirector</a></td>
...
<td>Releases all resources used by the Control.<br />(Overrides Form.Dispose(Boolean))</td></tr>
<tr>
...
<tr>
<td><a href="cdf7c36a-948c-fc1d-a56d-826479f9b3b6.md">OnAllowFormChromeChanged</a></td>
<td>Occurs when the AllowFormChromeChanged event is fired for the current palette.</td></tr>
<tr>
<td><a href="0e7fd274-5825-7b70-d6a3-96659f9fff0e.md">OnApplyCustomChromeChanged</a></td>
<td>Raises the ApplyCustomChrome event.</td></tr>
<tr>
...
<tr>
<td><a href="5eef951e-f41c-d3da-dee8-250ecad6e415.md">OnButtonSpecChanged</a></td>
...
<td>Process the WM_NCHITTEST message when overriding window chrome.</td></tr>
<tr>
...
<td>Perform chrome window painting in the non-client areas.</td></tr>
<tr>
...
<tr>
<td><a href="5a90b5a4-87c4-a521-a6fa-b6552e26ab26.md">OnPaint</a></td>
<td><br />(Overrides Form.OnPaint(PaintEventArgs))</td></tr>
<tr>
...
<td>Process a windows message that requires the non client area be repainted.</td></tr>
<tr>
<td><a href="3dae76c0-53e0-c370-b986-245edcba0cb0.md">OnPaletteChanged</a></td>
...
<tr>
<td><a href="e15e2e55-2817-fbe9-6ab9-7f7d70b8a601.md">OnWindowActiveChanged</a></td>
<td>Called when the active state of the window changes.</td></tr>
<tr>
<td><a href="18dfd270-8f40-6e61-dced-08a2f1d1f2cb.md">OnWM_GETMINMAXINFO</a></td>
<td>Creates and populates the MINMAXINFO structure for a maximized window. Puts the structure into memory address given by lParam. Only used to process a WM_GETMINMAXINFO message.</td></tr>
<tr>
<td><a href="191b39ff-6302-7710-c8e9-4252b06bfad3.md">OnWM_LBUTTONUP</a></td>
<td>Process the WM_LBUTTONUP message when overriding window chrome.</td></tr>
<tr>
<td><a href="bbf14895-2e70-1594-8766-ab9202d90ddc.md">OnWM_MOUSEMOVE</a></td>
<td>Process the OnWM_MOUSEMOVE message when overriding window chrome.</td></tr>
<tr>
<td><a href="4b430274-e41b-b2f7-4da6-8a1d09f57971.md">OnWM_NCACTIVATE</a></td>
<td>Process the WM_NCACTIVATE message when overriding window chrome.</td></tr>
<tr>
<td><a href="edfb09ce-4054-6fff-0c26-db2207a2677f.md">OnWM_NCCALCSIZE</a></td>
<td>Process the WM_NCCALCSIZE message when overriding window chrome.</td></tr>
<tr>
...
<td>Process the WM_NCLBUTTONDBLCLK message when overriding window chrome.</td></tr>
<tr>
<td><a href="03661d40-51ec-d327-8345-0c395bf10091.md">OnWM_NCLBUTTONDOWN</a></td>
<td>Process the WM_NCLBUTTONDOWN message when overriding window chrome.</td></tr>
<tr>
...
<td>Process the WM_NCMOUSELEAVE message when overriding window chrome.</td></tr>
<tr>
<td><a href="c50e34ac-3212-ec17-0fa6-2ded94556fc1.md">OnWM_NCMOUSEMOVE</a></td>
<td>Process the WM_NCMOUSEMOVE message when overriding window chrome.</td></tr>
<tr>
<td><a href="7dc324b9-6a23-a878-5faa-02e08fbdb4b3.md">OnWM_NCPAINT</a></td>
<td>Process the WM_NCPAINT message when overriding window chrome.</td></tr>
<tr>
...
<td>Request the non-client area be recalculated.</td></tr>
<tr>
...
<td>Resets the <a href="13b29650-b21b-35d6-8387-a6f0a5ca154d.md">KryptonForm</a> blur values.</td></tr>
<tr>
...
<td>Resets the <a href="13b29650-b21b-35d6-8387-a6f0a5ca154d.md">KryptonForm</a> shadow values.</td></tr>
<tr>
<td>ResetText</td>
...
<td>Resume processing of non-client painting.</td></tr>
<tr>
...
<td>Convert a screen location to a window location.</td></tr>
<tr>
...
<td>Performs the work of setting the specified bounds of this control.<br />(Overrides Form.SetBoundsCore(Int32, Int32, Int32, Int32, BoundsSpecified))</td></tr>
<tr>
...
<td>Start capturing mouse input for a particular element that is inside the chrome.</td></tr>
<tr>
<td>SuspendLayout</td>
...
<td>Suspend processing of non-client painting.</td></tr>
<tr>
<td>ToString</td>
...
<td>Causes all of the child controls within a control that support validation to validate their data.<br />(Inherited from Form)</td></tr>
<tr>
<td><a href="ab991224-877a-09e6-87b3-37d185adce4e.md">WindowChromeCompositionLayout</a></td>
<td>Perform layout on behalf of the composition element using our root element.</td></tr>
<tr>
<td><a href="e3a0442d-4645-c696-8e0a-d951773e6536.md">WindowChromeCompositionPaint</a></td>
<td>Perform painting on behalf of the composition element using our root element.</td></tr>
<tr>
<td><a href="28771d38-8a18-d31a-6584-23463d2846ff.md">WindowChromeEnd</a></td>
<td>Perform cleanup when custom chrome ending.</td></tr>
<tr>
<td><a href="550fa914-4310-1a0f-dd5e-f1a3a412fa70.md">WindowChromeHitTest</a></td>
<td>Perform hit testing.</td></tr>
<tr>
<td><a href="cd7680fa-660a-62d8-9396-ff70fc42160d.md">WindowChromeLeftMouseDown</a></td>
<td>Process the left mouse down event.</td></tr>
<tr>
<td><a href="0e57f1b8-3845-615e-8be2-aa7d4295bf0d.md">WindowChromeLeftMouseUp</a></td>
<td>Process the left mouse up event.</td></tr>
<tr>
...
<td>Perform non-client mouse movement processing.</td></tr>
<tr>
<td><a href="cb98a851-8885-0f5c-a481-c3f5757cdaaa.md">WindowChromePaint</a></td>
<td>Perform painting of the window chrome.</td></tr>
<tr>
<td><a href="6ba01ede-7120-4586-65f3-2c544f297e78.md">WindowChromeStart</a></td>
<td>Perform setup for custom chrome.</td></tr>
<tr>
<td><a href="9fec050f-ddd1-0131-2777-cd323b07285f.md">WndProc</a></td>
<td>Process Windows-based messages.<br />(Overrides Form.WndProc(Message))</td></tr>
</table>
...
<td>Occurs when the Global palette changes.</td></tr>
<tr>
<td>GotFocus</td>
