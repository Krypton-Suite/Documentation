...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorder = 23
```
**VB**
``` VB
Public Const RibbonGroupNormalBorder As PaletteRibbonColorStyle = 23
```
