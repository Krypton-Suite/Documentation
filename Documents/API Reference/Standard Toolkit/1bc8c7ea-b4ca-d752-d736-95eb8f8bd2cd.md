# ContextMenuItemHighlight Field
...
**C#**
``` C#
public const PaletteBorderStyle ContextMenuItemHighlight = 35
```
**VB**
``` VB
Public Const ContextMenuItemHighlight As PaletteBorderStyle = 35
```
