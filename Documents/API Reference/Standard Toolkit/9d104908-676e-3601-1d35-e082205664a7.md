...
**VB**
``` VB
Public MustOverride Function GetPreferredSize ( 
...
#### Return Value
Size  
\[Missing &lt;returns&gt; documentation for "M:Krypton.Toolkit.ViewBase.GetPreferredSize(Krypton.Toolkit.ViewLayoutContext)"\]
