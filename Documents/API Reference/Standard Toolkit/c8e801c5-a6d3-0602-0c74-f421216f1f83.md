# KryptonPictureBox Class


\[Missing &lt;summary&gt; documentation for "T:Krypton.Toolkit.KryptonPictureBox"\]
...
**VB**
``` VB
Public Class KryptonPictureBox
	Inherits PictureBox
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  PictureBox  →  KryptonPictureBox</td></tr>
</table>
...
<table>
<tr>
<td><a href="b2499da8-4017-1249-acac-64d4f699d05a.md">KryptonPictureBox</a></td>
<td>Initializes a new instance of the KryptonPictureBox class</td></tr>
</table>
...
<tr>
<td>CancelAsync</td>
<td>Cancels an asynchronous image load.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>Contains</td>
...
<td><br />(Inherited from PictureBox)</td></tr>
<tr>
<td>CreateControl</td>
...
<td>Releases the unmanaged resources used by the PictureBox and optionally releases the managed resources.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<tr>
<td>Load()</td>
<td>Displays the image specified by the ImageLocation property of the PictureBox.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>Load(String)</td>
<td>Sets the ImageLocation to the specified URL and displays the image indicated.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>LoadAsync()</td>
<td>Loads the image asynchronously.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>LoadAsync(String)</td>
<td>Loads the image at the specified location, asynchronously.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<td>Raises the EnabledChanged event.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>OnEnter</td>
...
<td>Raises the HandleCreated event.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>OnHandleDestroyed</td>
<td>Raises the HandleDestroyed event.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<tr>
<td>OnLoadCompleted</td>
<td>Raises the LoadCompleted event.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>OnLoadProgressChanged</td>
<td>Raises the LoadProgressChanged event.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<tr>
<td>OnPaint</td>
<td>Raises the Paint event.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<td>Raises the ParentChanged event.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<tr>
<td>OnResize</td>
<td>Raises the Resize event.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<tr>
<td>OnSizeModeChanged</td>
<td>Raises the SizeModeChanged event.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<td>Raises the VisibleChanged event.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>PerformLayout()</td>
...
<tr>
<td>ToString</td>
<td>Returns a string that represents the current PictureBox control.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>Update</td>
...
<tr>
<td>WndProc</td>
<td>Processes Windows messages.<br />(Inherited from Control)</td></tr>
</table>
...
<tr>
<td>LoadCompleted</td>
<td>Occurs when the asynchronous image-load operation is completed, been canceled, or raised an exception.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>LoadProgressChanged</td>
<td>Occurs when the progress of an asynchronous image-loading operation has changed.<br />(Inherited from PictureBox)</td></tr>
<tr>
...
<tr>
<td>SizeModeChanged</td>
<td>Occurs when SizeMode changes.<br />(Inherited from PictureBox)</td></tr>
<tr>
<td>StyleChanged</td>
