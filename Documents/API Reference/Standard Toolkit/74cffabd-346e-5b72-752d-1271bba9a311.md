# HeaderButtonPaddingCustom1 Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderButtonPaddingCustom1 = 13
```
**VB**
``` VB
Public Const HeaderButtonPaddingCustom1 As PaletteMetricPadding = 13
```
