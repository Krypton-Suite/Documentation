...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupAreaBorder3 = 20
```
**VB**
``` VB
Public Const RibbonGroupAreaBorder3 As PaletteRibbonColorStyle = 20
```
