# RibbonTabTracking2010Alt Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonTabTracking2010Alt = 10
```
**VB**
``` VB
Public Const RibbonTabTracking2010Alt As PaletteRibbonColorStyle = 10
```
