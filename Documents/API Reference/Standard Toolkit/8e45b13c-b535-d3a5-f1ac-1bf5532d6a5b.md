# KryptonDataGridViewCheckBoxColumn Class
...
**VB**
``` VB
Public Class KryptonDataGridViewCheckBoxColumn
	Inherits KryptonDataGridViewIconColumn
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  DataGridViewElement  →  DataGridViewBand  →  DataGridViewColumn  →  <a href="21f6015d-1ab5-4482-8193-6cf4882c3abf.md">KryptonDataGridViewIconColumn</a>  →  KryptonDataGridViewCheckBoxColumn</td></tr>
</table>
