...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalTitle = 36
```
**VB**
``` VB
Public Const RibbonGroupNormalTitle As PaletteRibbonColorStyle = 36
```
