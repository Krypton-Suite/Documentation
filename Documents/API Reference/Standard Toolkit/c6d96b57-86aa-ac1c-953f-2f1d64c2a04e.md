# RibbonGroupNormalBorderSepTrackingLight Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorderSepTrackingLight = 32
```
**VB**
``` VB
Public Const RibbonGroupNormalBorderSepTrackingLight As PaletteRibbonColorStyle = 32
```
