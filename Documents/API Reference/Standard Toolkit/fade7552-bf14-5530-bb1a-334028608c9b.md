...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupAreaBorder2 = 19
```
**VB**
``` VB
Public Const RibbonGroupAreaBorder2 As PaletteRibbonColorStyle = 19
```
