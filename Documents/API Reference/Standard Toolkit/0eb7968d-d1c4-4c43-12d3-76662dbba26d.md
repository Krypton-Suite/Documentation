# RibbonAppMenuDocsEntry Property
...
**C#**
``` C#
public virtual PaletteRibbonText RibbonAppMenuDocsEntry { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonAppMenuDocsEntry As PaletteRibbonText
	Get
```
