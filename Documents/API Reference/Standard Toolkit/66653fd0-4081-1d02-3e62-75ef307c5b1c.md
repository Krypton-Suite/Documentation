# GlassCheckedTrackingSimple Field
...
**C#**
``` C#
public const PaletteColorStyle GlassCheckedTrackingSimple = 46
```
**VB**
``` VB
Public Const GlassCheckedTrackingSimple As PaletteColorStyle = 46
```
