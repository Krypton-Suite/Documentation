# ContextMenuItemTextStandard Field
...
**C#**
``` C#
public const PaletteContentStyle ContextMenuItemTextStandard = 21
```
**VB**
``` VB
Public Const ContextMenuItemTextStandard As PaletteContentStyle = 21
```
