# KryptonDataGridViewDomainUpDownCell Class
...
**VB**
``` VB
Public Class KryptonDataGridViewDomainUpDownCell
	Inherits DataGridViewTextBoxCell
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  DataGridViewElement  →  DataGridViewCell  →  DataGridViewTextBoxCell  →  KryptonDataGridViewDomainUpDownCell</td></tr>
</table>
...
<table>
<tr>
<td><a href="efca5f01-b482-5424-053b-3b26283c8cd3.md">KryptonDataGridViewDomainUpDownCell</a></td>
<td>Constructor for the KryptonDataGridViewDomainUpDownCell cell type</td></tr>
</table>
