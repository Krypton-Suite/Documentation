...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonGroupBackArea { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonGroupBackArea As PaletteRibbonBack
	Get
```
