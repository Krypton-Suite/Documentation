# HeaderButtonEdgeInsetDockInactive Field
...
**C#**
``` C#
public const PaletteMetricInt HeaderButtonEdgeInsetDockInactive = 3
```
**VB**
``` VB
Public Const HeaderButtonEdgeInsetDockInactive As PaletteMetricInt = 3
```
