# RibbonTabContextSelected Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonTabContextSelected = 17
```
**VB**
``` VB
Public Const RibbonTabContextSelected As PaletteRibbonColorStyle = 17
```
