...
**VB**
``` VB
Public Class VisualContextMenu
	Inherits VisualPopup
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  <a href="65480817-09a3-f777-b651-c6e7d4b29f93.md">VisualPopup</a>  →  VisualContextMenu</td></tr>
<tr><td><strong>Derived</strong></td><td><a href="378cb482-a69a-0a92-7c04-1a942802a5eb.md">Krypton.Toolkit.VisualContextMenuDTP</a></td></tr>
</table>
...
<td>Gets access to the view manager for the context menu.</td></tr>
<tr>
