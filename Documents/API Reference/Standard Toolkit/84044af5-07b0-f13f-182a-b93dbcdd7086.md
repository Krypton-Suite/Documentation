...
**VB**
``` VB
Protected Overridable Sub OnBeforeLabelEdit ( 
	e As NodeLabelEditEventArgs
)
```
...
#### Parameters
<dl><dt>  NodeLabelEditEventArgs</dt><dd>An NodeLabelEditEventArgs that contains the event data.</dd></dl>
