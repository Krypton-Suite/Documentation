# PaletteBackInheritRedirect Class
...
**VB**
``` VB
Public Class PaletteBackInheritRedirect
	Inherits PaletteBackInherit
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  TypeConverter  →  ExpandableObjectConverter  →  <a href="9ef2ca3a-e03e-8927-105a-2f9a6fbdf849.md">GlobalId</a>  →  <a href="d6957f99-886c-46c2-1fd2-d1be6fd24eba.md">PaletteBackInherit</a>  →  PaletteBackInheritRedirect</td></tr>
</table>
