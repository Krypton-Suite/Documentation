...
**VB**
``` VB
Public Class KryptonPropertyGrid
	Inherits PropertyGrid
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  PropertyGrid  →  KryptonPropertyGrid</td></tr>
</table>
...
<table>
<tr>
<td><a href="2a7476e2-8502-220b-5fba-0aac8a3cdf07.md">KryptonPropertyGrid</a></td>
<td>Initializes a new instance of the KryptonPropertyGrid class</td></tr>
</table>
...
<tr>
<td>BackColor</td>
<td>Gets or sets the background color for the control.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>BrowsableAttributes</td>
<td>Gets or sets the browsable attributes associated with the object that the property grid is attached to.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CanEnableIme</td>
...
<tr>
<td>CanShowCommands</td>
<td>Gets a value indicating whether the commands pane can be made visible for the currently selected objects.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CanShowVisualStyleGlyphs</td>
<td>Gets or sets a value that indicates whether OS-specific visual style glyphs are used for the expansion nodes in the grid area.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Capture</td>
<td>Gets or sets a value indicating whether the control has captured the mouse.<br />(Inherited from Control)</td></tr>
<tr>
<td>CategoryForeColor</td>
<td>Gets or sets the text color used for category headings.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CategorySplitterColor</td>
<td>Gets or sets the color of the line that separates categories in the grid area.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>CommandsActiveLinkColor</td>
<td>Gets or sets the color of active links in the executable commands region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CommandsBackColor</td>
<td>Gets or sets the background color of the hot commands region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CommandsBorderColor</td>
<td>Gets or sets the color of the border surrounding the hot commands region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CommandsDisabledLinkColor</td>
<td>Gets or sets the unavailable link color for the executable commands region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CommandsForeColor</td>
<td>Gets or sets the foreground color for the hot commands region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CommandsLinkColor</td>
<td>Gets or sets the link color for the executable commands region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CommandsVisible</td>
<td>Gets a value indicating whether the commands pane is visible.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CommandsVisibleIfAvailable</td>
<td>Gets or sets a value indicating whether the commands pane is visible for objects that expose verbs.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CompanyName</td>
...
<tr>
<td>ContextMenuDefaultLocation</td>
<td>Gets the default location for the shortcut menu.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>DefaultSize</td>
<td>Gets the default size of the control.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>DefaultTabType</td>
<td>Gets the type of the default tab.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>DesignMode</td>
...
<tr>
<td>DisabledItemForeColor</td>
<td>Gets or sets the foreground color of disabled text in the grid area.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>DrawFlatToolbar</td>
<td>Gets or sets a value indicating whether the PropertyGrid control paints its toolbar with flat buttons.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Enabled</td>
...
<tr>
<td>HelpBackColor</td>
<td>Gets or sets the background color for the Help region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>HelpBorderColor</td>
<td>Gets or sets the color of the border surrounding the description pane.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>HelpForeColor</td>
<td>Gets or sets the foreground color for the Help region.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>HelpVisible</td>
<td>Gets or sets a value indicating whether the Help text is visible.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>LargeButtons</td>
<td>Gets or sets a value indicating whether buttons appear in standard size or in large size.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>LayoutEngine</td>
...
<tr>
<td>LineColor</td>
<td>Gets or sets the color of the gridlines and borders.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Location</td>
...
<tr>
<td>PropertySort</td>
<td>Gets or sets the type of sorting the PropertyGrid uses to display properties.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>PropertyTabs</td>
<td>Gets the collection of property tabs that are displayed in the grid.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>SelectedGridItem</td>
<td>Gets or sets the selected grid item.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>SelectedItemWithFocusBackColor</td>
<td>Gets or sets the background color of selected items that have the input focus.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>SelectedItemWithFocusForeColor</td>
<td>Gets or sets the foreground color of selected items that have the input focus.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>SelectedObject</td>
<td>Gets or sets the object for which the grid displays properties.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>SelectedObjects</td>
<td>Gets or sets the currently selected objects.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>SelectedTab</td>
<td>Gets the currently selected property tab.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>ShowFocusCues</td>
<td>Gets a value indicating whether the control should display focus rectangles.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>ShowPropertyPageImage</td>
<td>Gets the image that represents the property page.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Site</td>
<td>Gets or sets the site of the control.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Size</td>
<td>Gets or sets the height and width of the control.<br />(Inherited from Control)</td></tr>
<tr>
<td>SortByCategoryImage</td>
<td>Gets the image that represents sorting grid items by category.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>SortByPropertyImage</td>
<td>Gets the image that represents sorting grid items by property name.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>TabIndex</td>
...
<tr>
<td>Text</td>
<td>Gets or sets the text associated with this control.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>ToolbarVisible</td>
<td>Gets or sets a value indicating whether the toolbar is visible.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>ToolStripRenderer</td>
<td>Gets or sets the painting functionality for ToolStrip objects.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Top</td>
...
<td>Gets or sets a value that determines whether to use the Graphics class (GDI+) or the TextRenderer class (GDI) to render text.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>UseWaitCursor</td>
...
<tr>
<td>ViewBackColor</td>
<td>Gets or sets a value indicating the background color in the grid.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>ViewBorderColor</td>
<td>Gets or sets the color of the border surrounding the grid area.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>ViewForeColor</td>
<td>Gets or sets a value indicating the color of the text in the grid.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Visible</td>
...
<tr>
<td>CollapseAllGridItems</td>
<td>Collapses all the categories in the PropertyGrid.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Contains</td>
...
<td>Creates a new accessibility object for this control.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>CreateControl</td>
...
<tr>
<td>CreatePropertyTab</td>
<td>When overridden in a derived class, enables the creation of a PropertyTab.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>DefWndProc</td>
...
<td>Disposes of the resources (other than memory) used by the PropertyGrid.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>ExpandAllGridItems</td>
<td>Expands all the categories in the PropertyGrid.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>Finalize</td>
...
<tr>
<td>OnComComponentNameChanged</td>
<td>Raises the ComComponentNameChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<td>Raises the EnabledChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnEnter</td>
<td>Raises the Enter event.<br />(Inherited from Control)</td></tr>
<tr>
<td>OnFontChanged</td>
<td>Raises the FontChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>OnGotFocus</td>
<td>Raises the GotFocus event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnHandleCreated</td>
<td>Raises the HandleCreated event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnHandleDestroyed</td>
<td>Raises the HandleDestroyed event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>OnMouseDown</td>
<td>Raises the MouseDown event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnMouseEnter</td>
...
<tr>
<td>OnMouseMove</td>
<td>Raises the MouseMove event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnMouseUp</td>
<td>Raises the MouseUp event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnMouseWheel</td>
...
<tr>
<td>OnNotifyPropertyValueUIItemsChanged</td>
<td>Raises the NotifyPropertyValueUIItemsChanged() event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnPaddingChanged</td>
<td>Raises the PaddingChanged event.<br />(Inherited from ScrollableControl)</td></tr>
<tr>
<td>OnPaint</td>
<td>Raises the Paint event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>OnPropertySortChanged</td>
<td>Raises the PropertySortChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnPropertyTabChanged</td>
<td>Raises the PropertyTabChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnPropertyValueChanged</td>
<td>Raises the PropertyValueChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>OnResize</td>
<td>Raises the Resize event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>OnSelectedGridItemChanged</td>
<td>Raises the SelectedGridItemChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnSelectedObjectsChanged</td>
<td>Raises the SelectedObjectsChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>OnSizeChanged</td>
...
<td>Raises the SystemColorsChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<td>Raises the VisibleChanged event.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<td>Processes a dialog key.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>Refresh</td>
<td>Forces the control to invalidate its client area and immediately redraw itself and any child controls.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td><a href="f4ce19e1-d12a-bb36-29f5-2efb6ee5a825.md">RefreshColours</a></td>
<td>Refreshes the colours.</td></tr>
<tr>
<td>RefreshTabs</td>
<td>Refreshes the property tabs of the specified scope.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>ResetSelectedProperty</td>
<td>Resets the selected property to its default value.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
<td>ResetText</td>
...
<tr>
<td>ShowEventsButton</td>
<td>Displays or hides the events button.<br />(Inherited from PropertyGrid)</td></tr>
<tr>
...
<tr>
<td>WndProc</td>
<td>Processes Windows messages.<br />(Inherited from PropertyGrid)</td></tr>
</table>
