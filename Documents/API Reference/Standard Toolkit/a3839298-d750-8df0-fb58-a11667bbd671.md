...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonQATFullbar { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonQATFullbar As PaletteRibbonBack
	Get
```
