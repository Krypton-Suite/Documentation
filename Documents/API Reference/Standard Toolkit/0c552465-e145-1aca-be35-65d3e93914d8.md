...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonGroupCollapsedFrameBorder { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonGroupCollapsedFrameBorder As PaletteRibbonBack
	Get
```
