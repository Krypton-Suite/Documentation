# RibbonGroupNormalBorderTrackingLight Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorderTrackingLight = 35
```
**VB**
``` VB
Public Const RibbonGroupNormalBorderTrackingLight As PaletteRibbonColorStyle = 35
```
