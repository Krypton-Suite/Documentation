# ContextMenuItemImageColumn Field
...
**C#**
``` C#
public const PaletteBorderStyle ContextMenuItemImageColumn = 34
```
**VB**
``` VB
Public Const ContextMenuItemImageColumn As PaletteBorderStyle = 34
```
