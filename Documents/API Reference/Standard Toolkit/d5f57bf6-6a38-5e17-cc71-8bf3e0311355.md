...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonQATFullbarSquare = 45
```
**VB**
``` VB
Public Const RibbonQATFullbarSquare As PaletteRibbonColorStyle = 45
```
