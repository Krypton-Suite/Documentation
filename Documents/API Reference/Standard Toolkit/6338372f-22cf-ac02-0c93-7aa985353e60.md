# RibbonGroupNormalPressedDark Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalPressedDark = 26
```
**VB**
``` VB
Public Const RibbonGroupNormalPressedDark As PaletteRibbonColorStyle = 26
```
