# RibbonGroupNormalBorderSepPressedLight Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorderSepPressedLight = 30
```
**VB**
``` VB
Public Const RibbonGroupNormalBorderSepPressedLight As PaletteRibbonColorStyle = 30
```
