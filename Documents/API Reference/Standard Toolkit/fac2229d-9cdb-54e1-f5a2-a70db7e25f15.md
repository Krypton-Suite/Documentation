...
**C#**
``` C#
public Size GetSingleMonthSize(
	ViewLayoutContext context
)
```
**VB**
``` VB
Public Function GetSingleMonthSize ( 
...
#### Return Value
Size  
\[Missing &lt;returns&gt; documentation for "M:Krypton.Toolkit.ViewLayoutMonths.GetSingleMonthSize(Krypton.Toolkit.ViewLayoutContext)"\]
