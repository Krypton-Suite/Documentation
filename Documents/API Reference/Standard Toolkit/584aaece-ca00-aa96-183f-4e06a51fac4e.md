...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupAreaBorder4 = 21
```
**VB**
``` VB
Public Const RibbonGroupAreaBorder4 As PaletteRibbonColorStyle = 21
```
