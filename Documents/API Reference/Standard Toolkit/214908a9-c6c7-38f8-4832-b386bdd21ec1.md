# HeaderButtonPaddingDockActive Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderButtonPaddingDockActive = 9
```
**VB**
``` VB
Public Const HeaderButtonPaddingDockActive As PaletteMetricPadding = 9
```
