...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonTabSelected2010 = 13
```
**VB**
``` VB
Public Const RibbonTabSelected2010 As PaletteRibbonColorStyle = 13
```
