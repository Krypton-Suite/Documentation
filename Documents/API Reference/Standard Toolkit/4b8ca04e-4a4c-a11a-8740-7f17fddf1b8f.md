...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonTabTracking2010 = 9
```
**VB**
``` VB
Public Const RibbonTabTracking2010 As PaletteRibbonColorStyle = 9
```
