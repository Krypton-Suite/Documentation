...
**VB**
``` VB
Public Class KryptonLinkWrapLabel
	Inherits LinkLabel
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  Label  →  LinkLabel  →  KryptonLinkWrapLabel</td></tr>
</table>
...
<table>
<tr>
<td><a href="7e4608c6-5150-a0e4-d6a3-3d30a62fdcba.md">KryptonLinkWrapLabel</a></td>
<td>Initializes a new instance of the KryptonLinkWrapLabel class.</td></tr>
</table>
...
<tr>
<td>CalcImageRenderBounds</td>
<td>Determines the size and location of an image drawn within the Label control based on the alignment of the control.<br />(Inherited from Label)</td></tr>
<tr>
<td>Contains</td>
...
<td>Creates a new accessibility object for the LinkLabel control.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>CreateControl</td>
...
<tr>
<td>CreateHandle</td>
<td>Creates a handle for this control. This method is called by .NET, and should not be called by user code. Inheriting classes should always call base.CreateHandle when overriding this method.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td><a href="ecbd593d-5cdf-8302-330e-532402546c76.md">CreateToolStripRenderer</a></td>
...
<td>Clean up any resources being used.<br />(Overrides Label.Dispose(Boolean))</td></tr>
<tr>
...
<tr>
<td>DrawImage</td>
<td>Draws an Image within the specified bounds.<br />(Inherited from Label)</td></tr>
<tr>
<td>DrawToBitmap</td>
...
<td>Retrieves the size of a rectangular area into which a control can be fitted.<br />(Inherited from Label)</td></tr>
<tr>
...
<td>Raises the AutoSizeChanged event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
...
<td>Provides handling for the EnabledChanged event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnEnter</td>
<td>Raises the Enter event.<br />(Inherited from Control)</td></tr>
<tr>
<td>OnFontChanged</td>
<td>Raises the FontChanged event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
...
<tr>
<td>OnGotFocus</td>
<td>Raises the GotFocus event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnHandleCreated</td>
<td>Raises the HandleCreated event.<br />(Inherited from Control)</td></tr>
<tr>
<td>OnHandleDestroyed</td>
<td>Raises the HandleDestroyed event.<br />(Inherited from Label)</td></tr>
<tr>
...
<tr>
<td>OnKeyDown</td>
<td>Raises the OnKeyDown(KeyEventArgs) event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnKeyPress</td>
...
<tr>
<td>OnLinkClicked</td>
<td>Raises the LinkClicked event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnLocationChanged</td>
<td>Raises the LocationChanged event.<br />(Inherited from Control)</td></tr>
<tr>
<td>OnLostFocus</td>
<td>Raises the LostFocus event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
...
<tr>
<td>OnMouseDown</td>
<td>Raises the OnMouseDown(MouseEventArgs) event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnMouseEnter</td>
<td>Raises the MouseEnter event.<br />(Inherited from Label)</td></tr>
<tr>
<td>OnMouseHover</td>
<td>Raises the MouseHover event.<br />(Inherited from Control)</td></tr>
<tr>
<td>OnMouseLeave</td>
<td>Raises the OnMouseLeave(EventArgs) event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnMouseMove</td>
<td>Raises the OnMouseMove(MouseEventArgs) event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnMouseUp</td>
<td>Raises the OnMouseUp(MouseEventArgs) event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnMouseWheel</td>
...
<td>Raises the PaddingChanged event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td><a href="0eb662b3-2cff-0e46-9314-7539255cc1a7.md">OnPaint</a></td>
<td>Raises the Paint event.<br />(Overrides LinkLabel.OnPaint(PaintEventArgs))</td></tr>
<tr>
<td><a href="59ca564d-ceb6-8823-f40e-6c8464ec3a0c.md">OnPaintBackground</a></td>
<td>Raises the PaintBackground event.<br />(Overrides LinkLabel.OnPaintBackground(PaintEventArgs))</td></tr>
<tr>
...
<td>Raises the ParentChanged event.<br />(Inherited from Label)</td></tr>
<tr>
...
<td>Raises the RightToLeftChanged event.<br />(Inherited from Label)</td></tr>
<tr>
<td>OnSizeChanged</td>
...
<tr>
<td>OnTextAlignChanged</td>
<td>Raises the TextAlignChanged event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnTextChanged</td>
<td>Provides handling for the TextChanged event.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>OnValidated</td>
...
<td>Raises the VisibleChanged event.<br />(Inherited from Label)</td></tr>
<tr>
<td>PerformLayout()</td>
...
<tr>
<td>PointInLink</td>
<td>Gets the link located at the specified client coordinates.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>PointToClient</td>
...
<td>Preprocesses keyboard or input messages within the message loop before they are dispatched.<br />(Inherited from Control)</td></tr>
<tr>
<td><a href="33c17190-7e77-722b-afd5-6df00027bd1f.md">ProcessCmdKey</a></td>
<td>Processes a command key.<br />(Overrides Control.ProcessCmdKey(Message, Keys))</td></tr>
<tr>
<td>ProcessDialogChar</td>
<td>Processes a dialog character.<br />(Inherited from Control)</td></tr>
<tr>
<td>ProcessDialogKey</td>
<td>Processes a dialog key.<br />(Inherited from LinkLabel)</td></tr>
<tr>
...
<tr>
<td><a href="dc9039a4-a424-a93e-d4ff-3f8a046980d1.md">ProcessMnemonic</a></td>
<td>Processes a mnemonic character.<br />(Overrides Label.ProcessMnemonic(Char))</td></tr>
<tr>
...
<tr>
<td><a href="f525d967-ee4f-93bb-ec61-bb06253850e3.md">ResetPalette</a></td>
<td>Resets the Palette property to its default value.</td></tr>
<tr>
<td><a href="93f1f265-2e10-aa84-950e-64762b887e02.md">ResetPaletteMode</a></td>
...
<td>Activates a child control. Optionally specifies the direction in the tab order to select the control from.<br />(Inherited from LinkLabel)</td></tr>
<tr>
...
<tr>
<td>SetBoundsCore</td>
<td>Performs the work of setting the bounds of this control.<br />(Inherited from LinkLabel)</td></tr>
<tr>
...
<tr>
<td>ToString</td>
<td>Returns a string that represents the current Label.<br />(Inherited from Label)</td></tr>
<tr>
<td>Update</td>
...
<tr>
<td><a href="e640352d-ccb1-ae1c-9d5b-28c9af03c4e3.md">WndProc</a></td>
<td>Process Windows-based messages.<br />(Overrides LinkLabel.WndProc(Message))</td></tr>
</table>
...
<td>Occurs when the value of the AutoSize property changes.<br />(Inherited from Label)</td></tr>
<tr>
...
<tr>
<td>LinkClicked</td>
<td>Occurs when a link is clicked within the control.<br />(Inherited from LinkLabel)</td></tr>
<tr>
...
<tr>
<td><a href="90b6b81a-d6f5-9f70-f2a8-1298d5f7928a.md">PaletteChanged</a></td>
...
<td>Occurs when the value of the TabStop() property changes.<br />(Inherited from LinkLabel)</td></tr>
<tr>
<td>TextAlignChanged</td>
<td>Occurs when the value of the TextAlign property has changed.<br />(Inherited from Label)</td></tr>
<tr>
<td>TextChanged</td>
