...
**VB**
``` VB
Public MustOverride Function GetDropDownButtonImage ( 
...
#### Return Value
Image  
\[Missing &lt;returns&gt; documentation for "M:Krypton.Toolkit.PaletteBase.GetDropDownButtonImage(Krypton.Toolkit.PaletteState)"\]
