# KryptonContextMenuCollectionEditor.KryptonContextMenuCollectionForm Class
...
**C#**
``` C#
protected class KryptonContextMenuCollectionForm : CollectionEditor.CollectionForm
```
**VB**
``` VB
Protected Class KryptonContextMenuCollectionForm
	Inherits CollectionEditor.CollectionForm
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  Form  →  CollectionEditor.CollectionForm  →  KryptonContextMenuCollectionEditor.KryptonContextMenuCollectionForm</td></tr>
</table>
...
<table>
<tr>
<td><a href="2c992a45-3535-6763-7554-3e6fa15bd293.md">KryptonContextMenuCollectionEditor.KryptonContextMenuCollectionForm</a></td>
<td>Initialize a new instance of the KryptonContextMenuCollectionForm class.</td></tr>
</table>
...
<td>Indicates whether you can remove the original members of the collection.<br />(Inherited from CollectionEditor.CollectionForm)</td></tr>
<tr>
<td>CanSelectMultipleInstances</td>
<td>Indicates whether multiple collection items can be selected at once.<br />(Inherited from CollectionEditor.CollectionForm)</td></tr>
<tr>
...
<td>Creates a new instance of the specified collection item type.<br />(Inherited from CollectionEditor.CollectionForm)</td></tr>
<tr>
<td>DefWndProc</td>
...
<td>Destroys the specified instance of the object.<br />(Inherited from CollectionEditor.CollectionForm)</td></tr>
<tr>
<td>DisplayError</td>
<td>Displays the specified exception to the user.<br />(Inherited from CollectionEditor.CollectionForm)</td></tr>
<tr>
<td>Dispose()</td>
<td>Releases all resources used by the Component.<br />(Inherited from Component)</td></tr>
<tr>
<td>Dispose(Boolean)</td>
<td>Disposes of the resources (other than memory) used by the Form.<br />(Inherited from Form)</td></tr>
<tr>
...
<tr>
<td>GetService</td>
<td>Gets the requested service, if it is available.<br />(Inherited from CollectionEditor.CollectionForm)</td></tr>
<tr>
<td>GetStyle</td>
...
<tr>
<td><a href="3c200659-f7a7-336b-c9e3-25e576fe3c84.md">OnEditValueChanged</a></td>
<td>Provides an opportunity to perform processing when a collection value has changed.<br />(Overrides CollectionEditor.CollectionForm.OnEditValueChanged())</td></tr>
<tr>
...
<tr>
<td>OnPaint</td>
<td>Raises the Paint event.<br />(Inherited from Form)</td></tr>
<tr>
...
<tr>
<td>ShowEditorDialog</td>
<td>Shows the dialog box for the collection editor using the specified IWindowsFormsEditorService object.<br />(Inherited from CollectionEditor.CollectionForm)</td></tr>
<tr>
