...
\[Missing &lt;summary&gt; documentation for "T:Krypton.Toolkit.VScrollSkin"\]
...
**VB**
``` VB
Public Class VScrollSkin
	Inherits Panel
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  Panel  →  VScrollSkin</td></tr>
</table>
...
<td>Initializes a new instance of the VScrollSkin class</td></tr>
<tr>
...
<td>Releases the unmanaged resources used by the VScrollSkin and optionally releases the managed resources<br />(Overrides Control.Dispose(Boolean))</td></tr>
<tr>
