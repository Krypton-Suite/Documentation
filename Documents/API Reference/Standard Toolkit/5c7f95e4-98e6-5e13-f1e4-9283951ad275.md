# KryptonThemeBrowserForm Class


\[Missing &lt;summary&gt; documentation for "T:Krypton.Toolkit.KryptonThemeBrowserForm"\]
...
**C#**
``` C#
public class KryptonThemeBrowserForm : KryptonForm
```
**VB**
``` VB
Public Class KryptonThemeBrowserForm
	Inherits KryptonForm
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  Form  →  <a href="bd185a29-8954-1412-8e7c-67631bab3d9c.md">VisualForm</a>  →  <a href="13b29650-b21b-35d6-8387-a6f0a5ca154d.md">KryptonForm</a>  →  KryptonThemeBrowserForm</td></tr>
</table>
...
<table>
<tr>
<td><a href="dc842275-8e03-e207-9a56-0e061aeecb2d.md">KryptonThemeBrowserForm</a></td>
<td>Initializes a new instance of the KryptonThemeBrowserForm class.</td></tr>
</table>
