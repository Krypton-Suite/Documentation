# HeaderButtonPaddingCalendar Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderButtonPaddingCalendar = 11
```
**VB**
``` VB
Public Const HeaderButtonPaddingCalendar As PaletteMetricPadding = 11
```
