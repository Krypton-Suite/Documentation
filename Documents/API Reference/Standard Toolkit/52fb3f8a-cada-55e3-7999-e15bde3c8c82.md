# HeaderButtonEdgeInsetInputControl Field
...
**C#**
``` C#
public const PaletteMetricInt HeaderButtonEdgeInsetInputControl = 7
```
**VB**
``` VB
Public Const HeaderButtonEdgeInsetInputControl As PaletteMetricInt = 7
```
