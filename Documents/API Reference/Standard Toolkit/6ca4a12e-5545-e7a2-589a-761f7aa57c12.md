# SeparatorPaddingHighProfile Field
...
**C#**
``` C#
public const PaletteMetricPadding SeparatorPaddingHighProfile = 23
```
**VB**
``` VB
Public Const SeparatorPaddingHighProfile As PaletteMetricPadding = 23
```
