...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonQATOverflow { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonQATOverflow As PaletteRibbonBack
	Get
```
