...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonAppMenuDocs { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonAppMenuDocs As PaletteRibbonBack
	Get
```
