# ContextMenuItemShortcutText Field
...
**C#**
``` C#
public const PaletteContentStyle ContextMenuItemShortcutText = 23
```
**VB**
``` VB
Public Const ContextMenuItemShortcutText As PaletteContentStyle = 23
```
