...
**C#**
``` C#
public class ViewLayoutCrumbs : ViewComposite, 
	IContentValues
```
**VB**
``` VB
Public Class ViewLayoutCrumbs
	Inherits ViewComposite
	Implements IContentValues
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  TypeConverter  →  ExpandableObjectConverter  →  <a href="9ef2ca3a-e03e-8927-105a-2f9a6fbdf849.md">GlobalId</a>  →  <a href="309ac2d8-bfc5-c1a7-ab6a-4f4cf86a1ba6.md">ViewBase</a>  →  <a href="467f805c-296b-06ec-42f1-e965af0d0f04.md">ViewComposite</a>  →  ViewLayoutCrumbs</td></tr>
...
<table>
<tr>
<td><a href="b36f4767-5854-821f-a18f-23c7d20511b5.md">ViewLayoutCrumbs</a></td>
<td>Initialize a new instance of the ViewLayoutCrumbs class.</td></tr>
</table>
