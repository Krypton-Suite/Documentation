# RibbonGroupNormalBorderSepPressedDark Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorderSepPressedDark = 31
```
**VB**
``` VB
Public Const RibbonGroupNormalBorderSepPressedDark As PaletteRibbonColorStyle = 31
```
