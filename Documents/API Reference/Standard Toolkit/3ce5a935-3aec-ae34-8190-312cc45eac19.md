# HeaderButtonEdgeInsetDockActive Field
...
**C#**
``` C#
public const PaletteMetricInt HeaderButtonEdgeInsetDockActive = 4
```
**VB**
``` VB
Public Const HeaderButtonEdgeInsetDockActive As PaletteMetricInt = 4
```
