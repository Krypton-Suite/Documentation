# RibbonGroupNormalBorderSep Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorderSep = 29
```
**VB**
``` VB
Public Const RibbonGroupNormalBorderSep As PaletteRibbonColorStyle = 29
```
