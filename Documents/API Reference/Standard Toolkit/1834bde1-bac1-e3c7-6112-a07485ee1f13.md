...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonQATFullbarRound = 44
```
**VB**
``` VB
Public Const RibbonQATFullbarRound As PaletteRibbonColorStyle = 44
```
