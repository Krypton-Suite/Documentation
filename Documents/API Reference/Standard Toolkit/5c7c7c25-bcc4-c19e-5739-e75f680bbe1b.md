# HeaderButtonPaddingPrimary Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderButtonPaddingPrimary = 6
```
**VB**
``` VB
Public Const HeaderButtonPaddingPrimary As PaletteMetricPadding = 6
```
