# RibbonQATMinibarInactive Property
...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonQATMinibarInactive { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonQATMinibarInactive As PaletteRibbonBack
	Get
```
