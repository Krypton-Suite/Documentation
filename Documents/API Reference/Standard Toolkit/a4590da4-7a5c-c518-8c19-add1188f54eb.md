# RibbonGroupNormalBorderSepTrackingDark Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorderSepTrackingDark = 33
```
**VB**
``` VB
Public Const RibbonGroupNormalBorderSepTrackingDark As PaletteRibbonColorStyle = 33
```
