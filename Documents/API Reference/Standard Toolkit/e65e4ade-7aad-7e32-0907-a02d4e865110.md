# RibbonQATMinibarActive Property
...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonQATMinibarActive { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonQATMinibarActive As PaletteRibbonBack
	Get
```
