# HeaderGroupPaddingDockActive Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderGroupPaddingDockActive = 4
```
**VB**
``` VB
Public Const HeaderGroupPaddingDockActive As PaletteMetricPadding = 4
```
