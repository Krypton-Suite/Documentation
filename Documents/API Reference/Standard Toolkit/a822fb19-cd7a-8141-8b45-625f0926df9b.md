...
**VB**
``` VB
Public Class VisualPopupShadow
	Inherits Form
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  Form  →  VisualPopupShadow</td></tr>
</table>
...
<table>
<tr>
<td><a href="e4712801-0fb5-7711-b0e4-f39f26dd99e2.md">VisualPopupShadow</a></td>
<td>Initialize a new instance of the VisualPopupShadow class.</td></tr>
</table>
...
<tr>
<td><a href="b582c61c-d4ff-de40-2b15-6c6b4086bef4.md">CreateParams</a></td>
<td>Gets the creation parameters.<br />(Overrides Form.CreateParams)</td></tr>
<tr>
