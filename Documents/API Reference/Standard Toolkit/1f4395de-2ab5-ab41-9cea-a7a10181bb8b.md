...
**VB**
``` VB
Public Overridable Function AddToWorkspace ( 
	path As String,
...
#### Parameters
<dl><dt>  String</dt><dd>Path for finding the target KryptonDockingWorkspace.</dd><dt>  <a href="6152055e-8626-d35d-405b-6d965a03471a.md">KryptonPage</a>[]</dt><dd>Array of pages to be added.</dd></dl>
