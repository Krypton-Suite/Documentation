# RibbonGroupNormalBorderTracking Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalBorderTracking = 34
```
**VB**
``` VB
Public Const RibbonGroupNormalBorderTracking As PaletteRibbonColorStyle = 34
```
