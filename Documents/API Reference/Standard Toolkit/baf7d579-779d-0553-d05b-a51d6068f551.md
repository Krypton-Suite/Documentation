# HeaderButtonPaddingInputControl Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderButtonPaddingInputControl = 12
```
**VB**
``` VB
Public Const HeaderButtonPaddingInputControl As PaletteMetricPadding = 12
```
