# RibbonGroupNormalPressedLight Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalPressedLight = 25
```
**VB**
``` VB
Public Const RibbonGroupNormalPressedLight As PaletteRibbonColorStyle = 25
```
