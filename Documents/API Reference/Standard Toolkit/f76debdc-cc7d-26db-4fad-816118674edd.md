# ContextMenuItemTextAlternate Field
...
**C#**
``` C#
public const PaletteContentStyle ContextMenuItemTextAlternate = 22
```
**VB**
``` VB
Public Const ContextMenuItemTextAlternate As PaletteContentStyle = 22
```
