...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupGradientTwo = 41
```
**VB**
``` VB
Public Const RibbonGroupGradientTwo As PaletteRibbonColorStyle = 41
```
