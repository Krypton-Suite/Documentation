...
**VB**
``` VB
Public Class KryptonMaskedTextBox
	Inherits VisualControlBase
	Implements IContainedInputControl
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  <a href="692f3254-a85d-c457-f80c-15e27592145b.md">VisualControlBase</a>  →  KryptonMaskedTextBox</td></tr>
<tr><td><strong>Derived</strong></td><td><a href="456849ff-f62a-aabf-5b8b-1a805e76e898.md">Krypton.Toolkit.KryptonDataGridViewMaskedTextBoxEditingControl</a></td></tr>
...
<table>
<tr>
<td><a href="70d2ac9e-1e55-fa3e-6e2b-f95ba1aace4e.md">KryptonMaskedTextBox</a></td>
<td>Initialize a new instance of the KryptonMaskedTextBox class.</td></tr>
</table>
...
<td>Overridden. Returns a string that represents the current masked text box. This method overrides ToString.<br />(Overrides Component.ToString())</td></tr>
<tr>
<td>Update</td>
...
<td>Converts the user input string to an instance of the validating type.</td></tr>
<tr>
