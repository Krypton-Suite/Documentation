...
**C#**
``` C#
public const PaletteMetricPadding SeparatorPaddingCustom3 = 27
```
**VB**
``` VB
Public Const SeparatorPaddingCustom3 As PaletteMetricPadding = 27
```
