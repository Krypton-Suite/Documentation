# RibbonGroupNormalTrackingLight Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupNormalTrackingLight = 27
```
**VB**
``` VB
Public Const RibbonGroupNormalTrackingLight As PaletteRibbonColorStyle = 27
```
