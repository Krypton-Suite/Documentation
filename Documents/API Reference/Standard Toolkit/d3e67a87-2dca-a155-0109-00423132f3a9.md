...
**VB**
``` VB
Public Class PopupPageAllowConverter
	Inherits StringLookupConverter(Of PopupPageAllow)
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  TypeConverter  →  EnumConverter  →  <a href="99324d69-1df2-d667-2822-25e081918839.md">StringLookupConverter</a>(<a href="59a6bbb2-48fc-6a16-d2ca-eced3f7d9486.md">PopupPageAllow</a>)  →  PopupPageAllowConverter</td></tr>
</table>
...
<table>
<tr>
<td><a href="4efe0d65-d8cc-46db-a290-89e27c960829.md">PopupPageAllowConverter</a></td>
<td>Initializes a new instance of the PopupPageAllowConverter class</td></tr>
</table>
