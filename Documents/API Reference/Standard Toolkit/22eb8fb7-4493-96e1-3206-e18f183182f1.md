# HeaderPrimaryCornerRoundingRadius Property
...
**C#**
``` C#
public float HeaderPrimaryCornerRoundingRadius { get; set; }
```
**VB**
``` VB
Public Property HeaderPrimaryCornerRoundingRadius As Single
	Get
	Set
```
