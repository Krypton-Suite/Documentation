...
**C#**
``` C#
public virtual PaletteRibbonBack RibbonAppMenuInner { get; }
```
**VB**
``` VB
Public Overridable ReadOnly Property RibbonAppMenuInner As PaletteRibbonBack
	Get
```
