# PaletteRedirectDropDownButton Class
...
**VB**
``` VB
Public Class PaletteRedirectDropDownButton
	Inherits PaletteRedirect
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  <a href="6da77fa5-1590-4646-f2ea-70002c922aee.md">PaletteBase</a>  →  <a href="eb4bd14d-b283-a570-c104-b4d55603d473.md">PaletteRedirect</a>  →  PaletteRedirectDropDownButton</td></tr>
</table>
...
<tr>
<td><a href="e1dcafd1-95f5-550e-3a9d-f45605f3a5f7.md">GetDropDownButtonImage</a></td>
<td>Gets a drop down button image appropriate for the provided state.<br />(Overrides <a href="939a6275-0cdf-6d2a-0994-63e66204cf64.md">PaletteRedirect.GetDropDownButtonImage(PaletteState)</a>)</td></tr>
<tr>
