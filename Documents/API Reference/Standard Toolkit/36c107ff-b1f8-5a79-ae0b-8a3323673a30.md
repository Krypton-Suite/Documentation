# SeparatorHighInternalProfile Field
...
**C#**
``` C#
public const PaletteBorderStyle SeparatorHighInternalProfile = 67
```
**VB**
``` VB
Public Const SeparatorHighInternalProfile As PaletteBorderStyle = 67
```
