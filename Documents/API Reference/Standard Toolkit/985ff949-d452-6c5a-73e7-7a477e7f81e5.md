# KryptonStatusStrip Class


\[Missing &lt;summary&gt; documentation for "T:Krypton.Toolkit.KryptonStatusStrip"\]
...
**VB**
``` VB
Public Class KryptonStatusStrip
	Inherits StatusStrip
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ToolStrip  →  StatusStrip  →  KryptonStatusStrip</td></tr>
</table>
...
<table>
<tr>
<td><a href="60fd916e-bf05-558a-407d-95b0edbbda1a.md">KryptonStatusStrip</a></td>
<td>Initializes a new instance of the KryptonStatusStrip class</td></tr>
</table>
...
<td>Creates a new accessibility object for the control.<br />(Inherited from StatusStrip)</td></tr>
<tr>
<td>CreateControl</td>
...
<tr>
<td>CreateDefaultItem</td>
<td>Creates a default ToolStripStatusLabel with the specified text, image, and event handler on a new StatusStrip instance.<br />(Inherited from StatusStrip)</td></tr>
<tr>
...
<td>Releases the unmanaged resources used by the StatusStrip and optionally releases the managed resources.<br />(Inherited from StatusStrip)</td></tr>
<tr>
...
<td>Raises the HandleDestroyed event.<br />(Inherited from ToolStrip)</td></tr>
<tr>
...
<tr>
<td>OnLayout</td>
<td>Raises the Layout event.<br />(Inherited from StatusStrip)</td></tr>
<tr>
...
<td>Paints the background of the control.<br />(Inherited from StatusStrip)</td></tr>
<tr>
<td>OnPaintGrip</td>
...
<tr>
<td>OnSpringTableLayoutCore</td>
<td>Provides custom table layout for a StatusStrip.<br />(Inherited from StatusStrip)</td></tr>
<tr>
...
<td>Resets the collection of displayed and overflow items after a layout is done.<br />(Inherited from StatusStrip)</td></tr>
<tr>
...
<tr>
<td>WndProc</td>
<td>Processes Windows messages.<br />(Inherited from StatusStrip)</td></tr>
</table>
...
<td>This event is not relevant for this class.<br />(Inherited from StatusStrip)</td></tr>
<tr>
<td>Paint</td>
