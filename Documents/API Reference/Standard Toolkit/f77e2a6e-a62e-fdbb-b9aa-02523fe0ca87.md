...
**C#**
``` C#
public const PaletteMetricPadding SeparatorPaddingCustom2 = 26
```
**VB**
``` VB
Public Const SeparatorPaddingCustom2 As PaletteMetricPadding = 26
```
