# RibbonGroupCollapsedBack Field
...
**C#**
``` C#
public const PaletteRibbonBackStyle RibbonGroupCollapsedBack = 7
```
**VB**
``` VB
Public Const RibbonGroupCollapsedBack As PaletteRibbonBackStyle = 7
```
