# HeaderGroupPaddingDockInactive Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderGroupPaddingDockInactive = 3
```
**VB**
``` VB
Public Const HeaderGroupPaddingDockInactive As PaletteMetricPadding = 3
```
