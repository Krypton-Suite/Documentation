...
**C#**
``` C#
public const PaletteRibbonTextStyle RibbonGroupCheckBoxText = 4
```
**VB**
``` VB
Public Const RibbonGroupCheckBoxText As PaletteRibbonTextStyle = 4
```
