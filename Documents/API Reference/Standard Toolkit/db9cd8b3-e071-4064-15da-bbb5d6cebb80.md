# RibbonGroupCollapsedFrameBack Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupCollapsedFrameBack = 39
```
**VB**
``` VB
Public Const RibbonGroupCollapsedFrameBack As PaletteRibbonColorStyle = 39
```
