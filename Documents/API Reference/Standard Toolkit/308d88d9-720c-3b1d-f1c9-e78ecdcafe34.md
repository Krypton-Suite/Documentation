# RibbonGroupAreaBorderContext Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupAreaBorderContext = 22
```
**VB**
``` VB
Public Const RibbonGroupAreaBorderContext As PaletteRibbonColorStyle = 22
```
