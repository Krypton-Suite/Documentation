...
public abstract class DockingElement : Component, 
	IDockingElement, IEnumerable<IDockingElement>, IEnumerable
```
**VB**
``` VB
Public MustInherit Class DockingElement
	Inherits Component
	Implements IDockingElement, IEnumerable(Of IDockingElement), 
	IEnumerable
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.marshalbyrefobject" target="_blank" rel="noopener noreferrer">MarshalByRefObject</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.componentmodel.component" target="_blank" rel="noopener noreferrer">Component</a>  →  DockingElement</td></tr>
<tr><td><strong>Derived</strong></td><td><a href="b45217df-c31e-9df9-dd90-e39ac4e0ee6c.md">Krypton.Docking.DockingElementClosedCollection</a></td></tr>
<tr><td><strong>Implements</strong></td><td><a href="7a8c0862-7f74-27fa-175f-cc894ff97478.md">IDockingElement</a>, <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable</a>(<a href="7a8c0862-7f74-27fa-175f-cc894ff97478.md">IDockingElement</a>), <a href="https://learn.microsoft.com/dotnet/api/system.collections.ienumerable" target="_blank" rel="noopener noreferrer">IEnumerable</a></td></tr>
</table>
...
<table>
<tr>
<td><a href="20e322a9-a0b3-0a5c-3d7f-2cd86b77dd96.md">DockingElement</a></td>
<td>Initialize a new instance of the DockingElement class.</td></tr>
</table>
...
<td>Checks that this element has access to a docking manager, throwing exception if not.</td></tr>
<tr>
<td><a href="36af17fb-6f03-8f71-b4f2-fe0a3e74111f.md">DemandPagesNotBePresent</a></td>
<td>Checks that the provided set of pages are not already present in the docking hierarchy.</td></tr>
<tr>
...
<tr>
<td><a href="f39980a9-4987-15fd-26bf-b6577d3acd1a.md">GetEnumerator</a></td>
<td>Shallow enumerate over child docking elements.</td></tr>
<tr>
...
<td>Search up the parent chain looking for the specified type of object.</td></tr>
<tr>
...
<td>Perform docking element specific actions for loading a child xml.</td></tr>
<tr>
<td><a href="d91f6831-33d8-140e-5214-6687834c7260.md">LoadDockingElement</a></td>
<td>Perform docking element specific actions based on the loading xml.</td></tr>
<tr>
