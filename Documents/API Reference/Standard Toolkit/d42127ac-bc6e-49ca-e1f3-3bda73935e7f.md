# HeaderButtonPaddingDockInactive Field
...
**C#**
``` C#
public const PaletteMetricPadding HeaderButtonPaddingDockInactive = 8
```
**VB**
``` VB
Public Const HeaderButtonPaddingDockInactive As PaletteMetricPadding = 8
```
