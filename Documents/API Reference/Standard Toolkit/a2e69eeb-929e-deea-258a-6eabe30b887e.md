# HeaderButtonEdgeInsetCustom1 Field
...
**C#**
``` C#
public const PaletteMetricInt HeaderButtonEdgeInsetCustom1 = 8
```
**VB**
``` VB
Public Const HeaderButtonEdgeInsetCustom1 As PaletteMetricInt = 8
```
