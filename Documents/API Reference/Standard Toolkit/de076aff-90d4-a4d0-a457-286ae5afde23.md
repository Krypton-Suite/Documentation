...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonTabTracking2007 = 7
```
**VB**
``` VB
Public Const RibbonTabTracking2007 As PaletteRibbonColorStyle = 7
```
