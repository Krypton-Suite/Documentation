# RibbonGroupCollapsedBorder Field
...
**C#**
``` C#
public const PaletteRibbonColorStyle RibbonGroupCollapsedBorder = 37
```
**VB**
``` VB
Public Const RibbonGroupCollapsedBorder As PaletteRibbonColorStyle = 37
```
