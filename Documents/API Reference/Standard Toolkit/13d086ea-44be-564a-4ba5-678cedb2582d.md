# KryptonInputBoxForm Class


\[Missing &lt;summary&gt; documentation for "T:Krypton.Toolkit.KryptonInputBoxForm"\]
...
**C#**
``` C#
public class KryptonInputBoxForm : KryptonForm
```
**VB**
``` VB
...
<table><tr><td><strong>Inheritance</strong></td><td>Object  →  MarshalByRefObject  →  Component  →  Control  →  ScrollableControl  →  ContainerControl  →  Form  →  <a href="bd185a29-8954-1412-8e7c-67631bab3d9c.md">VisualForm</a>  →  <a href="13b29650-b21b-35d6-8387-a6f0a5ca154d.md">KryptonForm</a>  →  KryptonInputBoxForm</td></tr>
</table>
...
<td>Initializes a new instance of the KryptonInputBoxForm class</td></tr>
<tr>
