...
**C#**
``` C#
public const PaletteMetricPadding HeaderButtonPaddingForm = 10
```
**VB**
``` VB
Public Const HeaderButtonPaddingForm As PaletteMetricPadding = 10
```
