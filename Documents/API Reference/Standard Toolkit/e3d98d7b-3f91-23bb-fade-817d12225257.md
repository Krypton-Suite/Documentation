# HeaderSecondaryCornerRoundingRadius Property
...
**C#**
``` C#
public float HeaderSecondaryCornerRoundingRadius { get; set; }
```
**VB**
``` VB
Public Property HeaderSecondaryCornerRoundingRadius As Single
	Get
	Set
```
