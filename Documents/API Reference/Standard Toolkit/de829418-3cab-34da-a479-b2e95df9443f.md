# RibbonGroupRadioButtonText Field
...
**C#**
``` C#
public const PaletteRibbonTextStyle RibbonGroupRadioButtonText = 5
```
**VB**
``` VB
Public Const RibbonGroupRadioButtonText As PaletteRibbonTextStyle = 5
```
